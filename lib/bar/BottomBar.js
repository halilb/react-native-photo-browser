...
export default class BottomBar extends React.Component {
  ...
  static propTypes = {
    ...
    displayDetailButton: PropTypes.bool,
  ...
  _renderDetailButton() {
    const { displayDetailButton, onDetail } = this.props;

    if (displayDetailButton) {
      return (
        <TouchableOpacity style={[styles.button, { flex: 0 }]} onPress={onDetail}>
          <Image
