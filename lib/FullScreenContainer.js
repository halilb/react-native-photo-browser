...
export default class FullScreenContainer extends React.Component {
  ...
  _renderRow(media: Object, sectionID: number, rowID: number) {
    ...
    var self = this;
    var onPhotoLongPress = function(eventObj) {
      if(self.props.onPhotoLongPress instanceof Function) {
        self.props.onPhotoLongPress(eventObj, media)
      }
    }

    var key = media.key || `row_${rowID}`
