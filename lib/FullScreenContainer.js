...
export default class FullScreenContainer extends React.Component {
  ...
  static propTypes = {
     ...
     * opens grid view
     */
    onGridButtonTap: React.PropTypes.func,
     ...
     */
    toggleTopBar: React.PropTypes.func,

    /*
     * refresh the list to apply selection change
     */
    onMediaSelection: React.PropTypes.func,
    ...
    alwaysShowControls: React.PropTypes.bool,
    displayActionButton: React.PropTypes.bool,
    displayNavArrows: React.PropTypes.bool,
    displaySelectionButtons: React.PropTypes.bool,
    enableGrid: React.PropTypes.bool,
    useCircleProgress: React.PropTypes.bool,
    onActionButton: React.PropTypes.func,
  };
