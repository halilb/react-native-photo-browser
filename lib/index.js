...
export default class PhotoBrowser extends React.Component {
  ...
  static propTypes = {
    ...
    /*
     * Whether to render the TopBar or nah. This is different from displayTopBar,
     * which is used for fading away the bars and controls
     */
  ...
  render() {
    ...
    return (
      <View style={[styles.container, {
        paddingTop: (topBar && gridContainer) ? TOOLBAR_HEIGHT : 0,
      }]}>
        {gridContainer}
        {fullScreenContainer}
