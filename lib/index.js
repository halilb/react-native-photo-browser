...
export default class PhotoBrowser extends React.Component {
  ...
  _updateTitle(title, currentIndex) {
    this.setState({ title, currentIndex });
  }
    ...
    if (mediaList.length > 0) {
      ...
      fullScreenContainer = (
        <FullScreenContainer
          ...
          prefetchNext={this.props.prefetchNext}
          renderPhoto={this.props.renderPhoto}
        />
      );
    }
    ...
    return (
      <View style={[styles.container, {
        ...
        <TopBarComponent
          ...
          onBack={onBack}
          additionalTopBarRender={additionalTopBarRender}
          topBarContainerStyle={topBarContainerStyle}
